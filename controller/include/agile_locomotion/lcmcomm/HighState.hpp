...
class HighState
{
    public:
        ...
        /// speed of stand up or squat down
        float      forwardPosition;

        /// front or rear displacement, an integrated number form kinematics function, usually drift
        float      sidePosition;

        /// left or right displacement, an integrated number form kinematics function, usually drift
...
uint64_t HighState::_computeHash(const __lcm_hash_ptr *p)
{
    ...
    uint64_t hash = 0xb1ef133695605cf3LL +
